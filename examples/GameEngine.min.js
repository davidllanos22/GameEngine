...
Camera = function(a, b) {
    this.game = a, this.name = b, this.x, this.y, this.width, this.height, this.angle;
}, Camera.prototype.setPosition = function(a, b) {
    this.x = a, this.y = b;
}, Camera.prototype.setPosition = function(a, b) {
    ...
    renderInternal: function() {
        ...
        this.ctx.msImageSmoothingEnabled = !0), this.ctx.save(), this.renderer.renderCounter = 0, 
    ...
    clearScreen: function(a) {
        this.drawRect(0, 0, this.game.width, this.game.height, a);
    },
