...
Camera = function(a, b) {
    this.game = a, this.name = b, this.position = new Math.Vector2(0, 0), this.size = new Math.Vector2(a.width, a.height), 
    this.angle = 0;
    ...
    this.showPauseWhenNotFocused = !1, this.fillScreen = !1, this.meter = new FPSMeter({
        ...
        width: 100,
        theme: "transparent"
    }), this.meter.hide(), this.showFps = !1, this.gameScale = 1, this.scale = 1, this.fillScreenWithRatio = !1, 
    ...
    renderInternal: function() {
        ...
        this.ctx.scale(this.gameScale, this.gameScale), this.renderer.renderCounter = 0, 
