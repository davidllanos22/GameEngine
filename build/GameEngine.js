...
Camera = function(a, b) {
    ...
    document.body.appendChild(this.cvs), this.focused = !0, this.showPauseWhenNotFocused = !1, 
    this.focused && this.cvs.focus(), this.meter = new FPSMeter({
        position: "absolute",
        width: 100,
        theme: "transparent"
