 ...
 * Internal initialization.
 	*/
	var initInternal = function initInternal(game) {
 ...
 */
	var updateInternal = function updateInternal(game) {
 ...
 */
	var renderInternal = function renderInternal(game) {
 ...
 */
	var onFocusInternal = function onFocusInternal(game) {
		focused = true;
		game.onFocus();
	};
	/**
 ...
 */
	var onBlurInternal = function onBlurInternal(game) {
		focused = false;
		game.onBlur();
	};
	/**
 ...
 */
	var onResizeInternal = function onResizeInternal(game) {
 ...
 */
	...
	if (!useGL) ctx = cvs.getContext("2d");else {
	...
	cvs.onfocus = function () {
		onFocusInternal(self);
	};
	cvs.onblur = function () {
		onBlurInternal(self);
	};
	window.onresize = function () {
		onResizeInternal(self);
	};
