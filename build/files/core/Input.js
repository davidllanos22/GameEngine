...
Input = function (game) {
  ...
  this.mouseRender = function () {
    if (this.cursorImage != null) {
      if (this.cursorImage instanceof Image) this.game.graphics.image(this.input.cursorImage, this.game.input.mouse.x, this.game.input.mouse.y);
  ...
  this.cvs.onmousemove = function (e) {
    self.onMouseMove(this, e);
  };
  this.cvs.onmousedown = function (e) {
    self.onMouseDown(this, e);
  };
  this.cvs.onmouseup = function (e) {
    self.onMouseUp(this, e);
  };
};
